                    ...
                    <SheetHeader>
                        ...
                        <div className='container min-h-screen overflow-y-auto flex flex-col w-full justify-center items-center space-y-10 sm:space-y-20'>
                            ...
                            <motion.div
                                ...
                                <button className="group relative h-12 overflow-hidden overflow-x-hidden rounded-full border border-zinc-200 hover:border-white px-8 py-3 text-white hover:text-zinc-950 transition-all duration-500 font-poppins hidden lg:block">
                            ...
                            <motion.div
                                ...
                                <ul>
                                    <li>
                                        <Link href={`/#`} className='flex flex-row gap-x-1 items-center text-white font-instrument font-medium uppercase text-base sm:text-lg group relative leading-none'>
                                            Instagram
                                            <GoArrowUpRight className='size-5' />
                                            <motion.span
                                                initial={{ width: 0 }}
